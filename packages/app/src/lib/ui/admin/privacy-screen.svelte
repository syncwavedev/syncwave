...
<div class="page flex flex-col gap-3">
    ...
    <p>
        Your privacy is important to us. It is BridgeX OU&#39;s policy to
        ...
        across our website, <a href="https://syncwave.dev"
            >https://syncwave.dev</a
    ...
    <p>
        We may ask for personal information — for example, when you participate
        in any of our giveaways, sweepstakes or promotions or when you contact
        us — which may include one or more of the following:
    </p>
    <ul>
        <li>Name</li>
        <li>Email</li>
    ...
    <p>
        ...
        the purpose of publication, processing, or usage on our platform. All
    ...
    <p>
        ...
        Germany, United States, Estonia, and United Kingdom, or where we or our
    ...
    <p>
        ...
        policy. If you are a third party providing personal information about somebody
        else, you represent and warrant that you have such person's consent to provide
    ...
    <p>
        ...
        your personal information is required to provide you with a particular service
        or offer (for example processing transaction data), we will not deny you
    ...
    <p>
        ...
        data protection law and wish to make a complaint, please contact us using
        the details below and provide us with full details of the alleged breach.
    ...
    <p>
        ...
        of communications (including marketing communications), please contact us
    ...
    <p>
        ...
        processors&rdquo;). We, BridgeX OU, located at the address provided in
    ...
    <p>
        ...
        we are in the process of considering your objection in relation to processing
        on the basis of legitimate interests.
    </p>
    <p>
        <strong>Objecting to processing:</strong> You have the right to object to
        processing of your personal information that is based on our legitimate interests
        or public interest. If this is done, we must provide compelling legitimate
        grounds for the processing which overrides your interests, rights, and freedoms,
        in order to proceed with the processing of your personal information.
    </p>
    <p>
        ...
        this information in CSV format or other easily readable machine format. You
        may also have the right to request that we transfer this personal information
        to a third party.
    </p>
    <p>
        ...
        reasonable steps to delete your personal information from our current records.
        If you ask us to delete your personal information, we will let you know how
        the deletion affects your use of our website or products and services. There
        may be exceptions to this right for specific legal reasons which, if applicable,
        we will set out for you in response to your request. If you terminate or
        delete your account, we will delete your personal information within 7 days
        of the deletion of your account. Please be aware that search engines and
        similar third parties may still retain copies of your personal information
        that has been made public at least once, like certain profile information
        and public comments, even after you have deleted the information from our
    ...
    <p>
        ...
        of personal information we revealed to other organizations for their
