...
<div class="page flex flex-col gap-3">
	...
	<p>
		...
		<a href="https://syncwave.dev">https://syncwave.dev</a> and any related services
		provided by BridgeX OU.
	</p>
	<p>
		By accessing <a href="https://syncwave.dev">https://syncwave.dev</a>, you
		agree to abide by these Terms of Service and to comply with all applicable
		laws and regulations. If you do not agree with these Terms of Service, you
		are prohibited from using or accessing this website or using any other
		services provided by BridgeX OU.
	</p>
	<p>
		We, BridgeX OU, reserve the right to review and amend any of these Terms of
	...
	<p>These Terms of Service were last updated on 24 February 2025.</p>
	...
	<p>
		...
		owned by or licensed to BridgeX OU and are protected by applicable copyright
		and trademark law. We grant our users permission to download one copy of the
	...
	<p>
		...
		restrictions or the Terms of Service, and may be terminated by BridgeX OU at
		any time.
	</p>
	...
	<p>
		When you use our website or its associated services to post, upload, share
		or otherwise transmit content covered by intellectual property rights, you
		grant to us a non-exclusive, royalty-free, transferable, sub-licensable,
		worldwide license to use, distribute, modify, run, copy, publicly display,
		translate or otherwise create derivative works of your content in a manner
		that is consistent with your privacy preferences and our Privacy Policy.
	</p>
	<p>
	...
	<p>
		...
		information associated with your account in a manner that is consistent with
		your privacy preferences and our Privacy Policy.
	</p>
	<h2>Liability</h2>
	<p>
		Our website and the materials on our website are provided on an &apos;as
		is&apos; basis. To the extent permitted by law, BridgeX OU makes no
	...
	<p>
		In no event shall BridgeX OU or its suppliers be liable for any
		...
		website, even if BridgeX OU or an authorized representative has been
		notified, orally or in writing, of the possibility of such damage.
	</p>
	<p>
		In the context of this agreement, &ldquo;consequential loss&rdquo; includes
		any consequential loss, indirect loss, real or anticipated loss of profit,
		loss of benefit, loss of revenue, loss of business, loss of goodwill, loss
		of opportunity, loss of savings, loss of reputation, loss of use and/or loss
		or corruption of data, whether under statute, contract, equity, tort
	...
	<p>
		...
		general information purposes only. BridgeX OU does not warrant or make any
	...
	<h2>Links</h2>
	<p>
		BridgeX OU has not reviewed all of the sites linked to its website and is
		not responsible for the contents of any such linked site. The inclusion of
		any link does not imply endorsement, approval or control by BridgeX OU of
		the site. Use of any such linked site is at your own risk and we strongly
	...
	<p>
		...
		these Terms of Service immediately upon written notice to you for any breach
	...
	<p>
		...
		laws of Estonia. You irrevocably submit to the exclusive jurisdiction of the
