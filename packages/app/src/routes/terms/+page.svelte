...
<div class="page flex flex-col gap-3">
	...
	<p>
		By accessing <a href="https://syncwave.dev">https://syncwave.dev</a>,
		...
		using any other services provided by BridgeX OU.
	</p>
	<p>
		We, BridgeX OU, reserve the right to review and amend any of these Terms
	...
	<p>
		...
		owned by or licensed to BridgeX OU and are protected by applicable
	...
	<p>
		...
		restrictions or the Terms of Service, and may be terminated by BridgeX
		OU at any time.
	</p>
	...
	<p>
		...
		on this website, even if BridgeX OU or an authorized representative has
	...
	<p>
		...
		general information purposes only. BridgeX OU does not warrant or make
	...
	<h2>Links</h2>
	<p>
		BridgeX OU has not reviewed all of the sites linked to its website and
		is not responsible for the contents of any such linked site. The
		inclusion of any link does not imply endorsement, approval or control by
		BridgeX OU of the site. Use of any such linked site is at your own risk
	...
	<p>
		...
		the laws of Estonia. You irrevocably submit to the exclusive
